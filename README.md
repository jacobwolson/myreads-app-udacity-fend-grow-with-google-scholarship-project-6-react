...
I — Jacob W. Olson — used React to implement this app's functionality. A starter template that included the framework for the XML markup used, most all of the CSS stylings, the `BooksAPI.js` file with its content and methods, and other material, was provided by Udacity. 
